    ...
    <>
      <article>
        <header className="mx-auto max-w-screen-xl pt-28 text-center">
          <p className="text-gray-600">Published September 30, 2023</p>
          <h1 className="mt-2 text-3xl font-bold text-green-500 sm:text-5xl">
            Goodfarms Goes to Palawan
          </h1>
          <p className="mt-6 text-lg text-gray-700">
            Accompanied by Dealers & CB Andrew
          </p>
          <div
          ...
          {/* <Image
              ...
              width={1170}
              height={600}
              className="sm:h-[34rem] mt-10 h-1/2 w-full object-contain"
              src="/images/palawan/palawan.jpg"
              quality={100}
              alt="Featured Image"
            /> */}
