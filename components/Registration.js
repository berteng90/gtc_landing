...
export const Registration = () => {
  return (
    <div className="flex w-full flex-wrap text-gray-800">
      <div className="relative hidden h-screen select-none flex-col justify-center bg-gray-100 text-center md:flex md:w-1/2">
        <div className="mx-auto py-16 px-8 text-white xl:w-[40rem]">
          ...
          <h1 className="font-bold mt-5 text-3xl  leading-tight text-gray-600 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
            <span className="relative inline-flex justify-center whitespace-nowrap font-bold text-transparent bg-clip-text bg-gradient-to-br from-amber-400 from-20% via-green-500 via-30% to-amber-300">
              <svg
                className="absolute -bottom-8 hidden w-2/3 text-amber-400 sm:block"
                viewBox="0 0 490 42"
                fill="none"
      ...
      <div class="lg:m-10">
        <form class="relative border border-gray-100 space-y-3 max-w-screen-md mx-auto rounded-md bg-white p-6 shadow-xl lg:p-10">
          ...
          <div>
            <button
              type="button"
              class="mt-5 w-full rounded-md bg-green-500 p-2 text-center font-semibold text-white"
            >
              Get Started
            </button>
          </div>
